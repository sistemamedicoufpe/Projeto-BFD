    ...
    >
        ...
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }: { isActive: boolean }) =>
              `flex items-center gap-3 px-4 py-3 min-h-[44px] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-inset ${
                isActive
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={logout}
            className="p-2 min-w-[44px] min-h-[44px] text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-red-500"
